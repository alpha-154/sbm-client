...
export default function BusinessSection() {
  return (
    <section className="bg-pink-50 max-w-4xl mx-auto px-6 md:px-8 pt-12 md:pt-16 lg:pt-20 border rounded-xl relative mt-10">
      <div className="">
        {/* Main Heading */}
        <h2 className="text-2xl md:text-3xl  font-bold text-center lg:text-left mb-8 md:mb-12 max-w-4xl mx-auto tracking-wider">
        ...
        <div className="space-y-6 max-w-4xl mx-auto text-center lg:text-left mb-12 md:mb-16">
          <p className="text-gray-700 text-md">
            ...
            <span className="text-[#80184E]">your business</span> on a personal
            level. Align our{" "}
            <span className="text-[#80184E]">marketing strategies</span> with
            your energy and lifestyle, ensuring that every campaign reflects
            your <span className="text-[#80184E]">authenticity</span>.
          </p>
          <p className="text-[#626262] text-md">
            We strive to create a{" "}
            <span className="text-[#80184E]">genuine partnership</span> with
            you, always doing what&apos;s best for your business. Your success
            is our success, and we&apos;re committed to going the extra mile to
            help you <span className="text-[#80184E]">achieve your goals</span>
            .
          </p>
        </div>
          ...
          <div className="relative grid md:grid-cols-3 gap-8 max-w-5xl mx-auto p-8 md:p-12">
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="w-12 h-12 bg-pink-200 rounded-full flex items-center justify-center">
                <Target className="w-6 h-6 text-[#80184E]" />
              </div>
              <p className="text-[#626262] text-md">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="w-12 h-12 bg-pink-200 rounded-full flex items-center justify-center">
                <Users className="w-6 h-6 text-[#80184E]" />
              </div>
              <p className="text-[#626262] text-md">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="w-12 h-12 bg-pink-200 rounded-full flex items-center justify-center">
                <TrendingUp className="w-6 h-6 text-[#80184E]" />
              </div>
              <p className="text-[#626262] text-md">
